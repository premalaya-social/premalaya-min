    ...
    $document.ready(function(){
        ...
        */
        ...
        if ($.fn.countdown){
            ...
            $clock.countdown(untilDate, function(e){
                $(this).html(e.strftime(''
                    + '<div class="clock-item" style="display:inline;padding:20px">%D <span>Days</span></div>'
                    + '<div class="clock-item" style="display:inline;padding:20px">%H <span>Hr</span></div>'
                    + '<div class="clock-item" style="display:inline;padding:20px;padding:20px">%M <span>Min</span></div>'
                    + '<div class="clock-item" style="display:inline;padding:20px">%S <span>Sec</span></div>'));
            });
        }
